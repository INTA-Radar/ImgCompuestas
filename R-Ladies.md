...
+Por favor, notar que toda mención a Mujeres o Femenino en este documento es utilizando de forma inclusiva en mujeres trans, … y personas no binarias que significativamente se identificadan como mujeres.  *Note: I dont know which are the correct words
...
### Alineación a la marca en espacios on line  *Note: maybe we must remove the "on line" words??, after all the logo is used in on-line and off-line places...
...
- "Síguenos en twitter @RLadies [Ubicación] y @RLadiesGlobal" *Note: I add this, not in original Rules and Guidelines: (Pueden mencionar otrs capítulos en tu país o provincia/estado.)*
...
*Note: this not exist in English versión, but Facebook is the most used social network in Latam Conuntry and the most used in small places (like my city). So I think this is a important place to exploit.*
